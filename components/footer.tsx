'use client';
import Link from "next/link"; // Added for functionality
import { 
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4">
            <Link href="/" className="flex items-center gap-2 mb-6 group cursor-pointer">
              <div className="w-10 h-10 bg-[#102321] rounded-xl flex items-center justify-center text-white font-black italic text-xl shadow-lg shadow-[#102321]/20 group-hover:bg-[#F56476] transition-all">
                T
              </div>
            ...
            <div className="flex gap-4">
              {[
                ...
                <a key={i} href={social.href} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border border-stone-200 rounded-xl flex items-center justify-center text-[#102321] hover:bg-[#F56476] hover:text-white hover:border-[#F56476] transition-all shadow-sm">
                  <social.Icon size={20} />
                </a>
              ))}
            </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-[12px] font-black uppercase tracking-tight text-[#102321]">
              <li><Link href="/library" className="hover:text-[#F56476] transition-colors cursor-pointer">Your Library</Link></li>
              <li><Link href="/creators" className="hover:text-[#F56476] transition-colors cursor-pointer">Creators</Link></li>
              <li><Link href="/login" className="hover:text-[#F56476] transition-colors flex items-center gap-2 cursor-pointer"><RiUserLine /> Login</Link></li>
              <li><Link href="/terms" className="hover:text-[#F56476] transition-colors flex items-center gap-2 cursor-pointer"><RiShieldLine /> Rulebook</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-[12px] font-black uppercase tracking-tight text-[#102321]">
              <li><Link href="/merchstore" className="hover:text-[#F56476] transition-colors flex items-center gap-2 cursor-pointer"><RiShoppingBag3Line /> Merch Store</Link></li>
              <li><Link href="/sponsorcomic" className="hover:text-[#F56476] transition-colors cursor-pointer">Sponsor a Comic</Link></li>
              <li><Link href="/donate" className="hover:text-[#F56476] transition-colors flex items-center gap-2 cursor-pointer"><RiHeart2Fill /> Donate</Link></li>
            </ul>
          </div>
            ...
            <div className="bg-[#102321] p-8 rounded-[2.5rem] text-white shadow-2xl shadow-[#102321]/20 relative overflow-hidden group">
              <div className="relative z-10">
                ...
                <Link href="/buyuscoffee">
                  <button className="w-full py-4 bg-[#F56476] text-white font-black text-[10px] uppercase tracking-[0.2em] rounded-2xl hover:bg-white hover:text-[#102321] transition-all flex items-center justify-center gap-2 active:scale-95">
        ...
        <div className="border-t border-stone-200 pt-10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8 text-[9px] font-black text-stone-400 uppercase tracking-widest">
            <Link href="/privacy" className="hover:text-[#102321] cursor-pointer">Privacy Policy</Link>
            <Link href="/cookies" className="hover:text-[#102321] cursor-pointer">Cookie Settings</Link>
            <Link href="/api" className="hover:text-[#102321] cursor-pointer">API Documentation</Link>
          </div>
        </div>
      </div>
    </footer>
